                     ...
                     <div class="row">
                      <div class="col-sm-10" >
                          <div class="container">
                           <div class="media p-3">
                             <?php
                            $img_url = 'images/'.$siteUrl->event_img;
                            if(strpos($siteUrl->event_img, 'http') === 0) // if check img url is http or https
                                $img_url = $siteUrl->event_img;
                             ?>
                             <a href="{{ $siteUrl->URL }}" >
                               <img src="{{$img_url}}" class="mr-3 rounded-circle" style="width:47px;">
                             </a>
